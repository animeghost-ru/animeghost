...
$cfg['error'] = ['success' => 'Успех','empty' => 'Пустое значение, заполните поля','wrong' => 'Неправильное значение','authorized' => 'Уже авторизован','registered' => 'Уже зарегистрирован','long' => 'Слишком длинное значение','short' => 'Слишком короткое значение','wrongLogin' => 'Неправильный логин','wrongEmail' => 'Неправильный email','wrongUserAgent' => 'Неправильный user agent','invalidUser' => 'Неправильный пользователь','wrongPasswd' => 'Неправильный пароль','wrongNewPasswd' => 'Новый пароль не совпадает','samePasswd' => 'Использован старый пароль','noUser' => 'Нет такого пользователя','checkEmail' => 'Проверьте почту','unauthorized' => 'Неавторизованный пользователь','access' => 'Доступ запрещен','same' => 'Одинаковые данные','used' => 'Уже занято','wrongData' => 'Неправильные данные'];
